...
public:
	...
	enum SoundsType { startGame = 1, launchBall = 2, ObjCol1
		= 3, ObjCol3 = 0, songGeneralGame = 4, ObjCol2 = 5, paletasSound = 6, pierdeSound = 7, missionCumplida = 8, campanasRepican = 9, hamburguesa = 10, palmeras = 11, cara1 = 12, cara2 = 13, mision = 14, bancos1 = 15, bancos2 = 16/* , voces1 = 8, voces2 = 9, voces3 = 10, musicWait = 11 */};
